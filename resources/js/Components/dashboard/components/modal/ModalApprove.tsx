                ...
                >
                    <div className="fixed inset-0 z-20 w-screen bg-black/60 overflow-y-auto">
                        <div className="flex min-h-full items-center justify-center p-4">
                            ...
                            >
                                <DialogPanel className="w-full max-w-3xl rounded-xl bg-white dark:bg-graydark p-6">
                                    <DialogTitle
                                        as="h3"
                                    ...
                                    <div className="mt-4">
                                        {footer ? (
                                            ...
                                            <button
                                                type="button"
                                                className="text-end text-white bg-blue-700 hover:!bg-blue-800 focus:!ring-4 focus:!ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 dark:!bg-blue-600 dark:hover:!bg-blue-700 focus:outline-none dark:focus:!ring-blue-800"
                                                onClick={onClose}
                                            >
                                                Close
                                            </button>
