...
Route::get('/dashboard/kurirs', function () {
...
Route::get('/dashboard/dokters', function () {
...
Route::get('/dashboard/obats', function () {
...
Route::get('/dashboard/apotekers', function () {
...
Route::get('/dashboard/operators', function () {
